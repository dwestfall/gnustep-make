...
override GNUSTEP_CONFIG_FILE = $(DESTDIR)/etc/GNUstep/GNUstep.conf
override GNUSTEP_CONFIG_FILE_DIR = $(dir $(GNUSTEP_CONFIG_FILE))
tooldir = $(DESTDIR)/usr/bin
makedir = $(DESTDIR)/usr/lib/GNUstep/Makefiles
mandir  = $(DESTDIR)/usr/share/man
srcdir = .


override GNUSTEP_IS_FLATTENED = yes
override GNUSTEP_TARGET_CPU = ix86
override GNUSTEP_TARGET_VENDOR = pc
override GNUSTEP_TARGET_OS = linux-gnu

override GNUSTEP_LIB_COMBO = gnu-gnu-gnu
